...
public class WorkerBehavior extends AbstractBehavior<WorkerBehavior.Command> {
    ...
    public Receive<Command> createReceive() {
        return this.handleMessageWhenWeDontYetHaveAPrimeNumber();
    }
    ...
    public Receive<Command> handleMessageWhenWeDontYetHaveAPrimeNumber() {
        return this.newReceiveBuilder()
                .onAnyMessage(command -> {
                    ...
                    return this.handleMessageWhenWeAlreadyHaveAPrimeNumber(prime);
                })
                .build();
    }

    public Receive<Command> handleMessageWhenWeAlreadyHaveAPrimeNumber(BigInteger prime) {
        return this.newReceiveBuilder()
                .onAnyMessage(command -> {
                    command.getSender().tell(new ManagerBehavior.ResultCommand(prime));
                    return this;
